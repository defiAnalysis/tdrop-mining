...
contract('HighVibes-TDrop-Liquidity-Mining', (accounts) => {
    ...
    it('Basic TDrop Mining Test', async () => {
        let nftTokenID           = 9999999999999
    ...
    it('Like TDrop Mining Test', async () => {
        let nftTokenID           = 7777777777777
        let highestSellingPriceInThePast = new BN(0)
        let currentTradePrice    = (new BN(122)).mul(dec18)
    ...
    it('Burn Vibes TDrop Mining Test', async () => {
        let nftTokenID           = 6666666666666
        let highestSellingPriceInThePast = new BN(0)
        let currentTradePrice    = (new BN(122)).mul(dec18)
    ...
    it('Burn TFuel TDrop Mining Test', async () => {
        let nftTokenID           = 5555555555555
        let currentTradePrice    = (new BN(122)).mul(dec18)
        let highestSellingPriceInThePast = new BN(0)
    ...
    it('NFT TDrop Mining Test', async () => {
        let nftTokenID           = 9912879027087
        let highestSellingPriceInThePast = new BN(0)
        let currentTradePrice    = (new BN(122)).mul(dec18)
